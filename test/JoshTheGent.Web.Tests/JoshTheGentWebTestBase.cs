...
using JoshTheGent.Models.TokenAuth;
...
{
    public abstract class JoshTheGentWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static JoshTheGentWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(JoshTheGentWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<JoshTheGentDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<JoshTheGentDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<JoshTheGentDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<JoshTheGentDbContext, Task<T>> func)
        {
            T result;
